...
$logo_args = array(
	...
	'description'            => _x( 'This will replace site title and tagline with logo in header area. Recommended maximum height for the logo size is 100px.', 'customizer', 'nokonoko' ),
);
